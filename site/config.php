...
$mfw->config['debug']['db-num-queries'] = true;
$mfw->config['debug']['db-queries'] = true;
 ...
 * Template files can reside in the parent or current theme, the CMvcFrameWork::ThemeEngineRender()
...
$mfw->config['theme'] = array(
  ...
  'data' => array(
    ...
    'favicon' => 'bart_biker.jpg',
    'logo' => 'bart_biker.jpg',
    'logo_width'  => 80,
    'logo_height' => 80,
    'footer' => '<p>MvcFrameWork &copy; by Lennart J&ouml;nsson (bo.lennart.jonsson@gmail.com)</p>',
  ),
);
