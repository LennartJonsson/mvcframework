...
{
  echo "MvcFrameWork: Uncaught exception: <p>" . $e->getMessage() . "</p><pre>" . $e->getTraceAsString(), "</pre>";
}
...
{
  return htmlentities($str, $flags, CMvcFrameWork::Instance()->config['character_encoding']);
}
