<?php
/**
* Holding a instance of CMvcFrameWork to enable use of $this in subclasses and provide some helpers.
*
...
class CObject
{
  ...
  /**
   * Wrapper for same method in CMvcFrameWork. See code for documentation.
   */
