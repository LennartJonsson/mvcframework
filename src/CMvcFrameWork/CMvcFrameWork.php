 ...
 */
class CMvcFrameWork implements ISingleton
{
   ...
   * @return CMvcFrameWork The instance of this class.
   */
  public static function Instance()
  {
    if(self::$instance == null)
    {
      self::$instance = new CMvcFrameWork();
    }
  ...
  public function ThemeEngineRender()
  {
    ...
    $themePath  = MFW_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    $mfw = &$this;
    // First the default MvcFrameWork themes/functions.php
