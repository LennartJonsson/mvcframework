...
class CTextFilter
{
  ...
  public static function SyntaxHighlightGeSHi($text, $language)
  {
    if(!self::$geshi)
    {
      ...
      //CMvcFrameWork::Instance()->views->AddStyle($geshi->get_stylesheet());
    }
...
$href = " href='" . CMvcFrameWork::Instance()->CreateUrl('author', $matches[4]) . "'";
...
EOD;
        ...
        case 'BASEURL': return CMvcFrameWork::Instance()->request->base_url; break;
