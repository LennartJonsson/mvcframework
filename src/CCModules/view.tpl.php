...
<tbody>
  <tr><td>Part of MvcFrameWork Core modules</td><td><?=$module['isMvcFrameWorkCore']?'Yes':'No'?></td></tr>
  <tr><td>Part of MvcFrameWork CMF modules</td><td><?=$module['isMvcFrameWorkCMF']?'Yes':'No'?></td></tr>
